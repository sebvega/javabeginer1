...
public class EjemploImprenta {
    public static void main(String[] args) {
        Curriculum cv = new Curriculum(new Persona("Juan ","Juanito "), "ingeniero electronico", "Resumen del curriculum...");
        cv.addExperiencia("Java")
                .addExperiencia("MySQL")
                .addExperiencia("Spring Framenwork")
                .addExperiencia("Angular");

        Libro libro = new Libro(new Persona("Juanita","Juancha")
                , "El inicio del fin", Genero.TERROR);
        libro.addPagina(new Pagina("habia una vez"))
                .addPagina(new Pagina("truz"))
                .addPagina(new Pagina("fin del fin"));

        Informe informe = new Informe(new Persona("Juan","Juanito Perez"), "Juanita", "Estudio de microservicios");
